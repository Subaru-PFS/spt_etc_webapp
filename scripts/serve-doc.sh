#!/usr/bin/env bash
#
# serve-doc.sh - Start MkDocs development server for documentation
#
# Usage:
#   ./scripts/serve-doc.sh [uv|pdm|venv]
#
# This script starts the MkDocs development server for previewing
# documentation changes. Auto-detects package manager (uv > pdm > venv).
#
# Requirements:
#   - mkdocs optional dependencies must be installed
#   - Working directory will be changed to docs/
#
...
cd "${PROJECT_ROOT}/docs" && exec ${RUNNER} mkdocs serve
