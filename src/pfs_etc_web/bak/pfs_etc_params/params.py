...
class OutputConf(param.Parameterized):
    outdir = param.String(label="Output Directory", default=default_parameters.outdir)
    noise = param.String(
        label="Noise spectrum", default=default_parameters.outfile_noise
    )
    sn_cont = param.String(
        label="Continuum S/N", default=default_parameters.outfile_sn_continuum
    )
    sn_line = param.String(label="Line S/N", default=default_parameters.outfile_sn_line)
    sn_oii = param.String(label="[OII] S/N", default=default_parameters.outfile_sn_oii)

    simspec = param.String(
        label="Simulation output", default=default_parameters.outfile_simspec
    )
